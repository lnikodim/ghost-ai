...
- copy the project link with a temporary `Copied!` feedback
...
Collaborators are stored by email in the DB.
...
- collaborator names/avatars load from Clerk if available
